...
// .svelte-kit/output/server/entries/pages/datenschutz/_page.svelte.js
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/datenschutz/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `<div class="${"outer svelte-1voksky"}"><h1 class="${"svelte-1voksky"}">Datenschutzerkl\xE4rung</h1>
	<div class="${"svelte-1voksky"}"><h2>Datenschutz</h2>
		<p class="${"svelte-1voksky"}">Die Nutzung unserer Webseite ist in der Regel ohne Angabe personenbezogener Daten m\xF6glich.
			Soweit auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder
			eMail-Adressen) erhoben werden, erfolgt dies, soweit m\xF6glich, stets auf freiwilliger Basis.
			Diese Daten werden ohne Ihre ausdr\xFCckliche Zustimmung nicht an Dritte weitergegeben.
		</p>
		<p class="${"svelte-1voksky"}">Wir weisen darauf hin, dass die Daten\xFCbertragung im Internet (z.B. bei der Kommunikation per
			E-Mail) Sicherheitsl\xFCcken aufweisen kann. Ein l\xFCckenloser Schutz der Daten vor dem Zugriff
			durch Dritte ist nicht m\xF6glich.
		</p>
		<p class="${"svelte-1voksky"}">Der Nutzung von im Rahmen der Impressumspflicht ver\xF6ffentlichten Kontaktdaten durch Dritte zur
			\xDCbersendung von nicht ausdr\xFCcklich angeforderter Werbung und Informationsmaterialien wird
			hiermit ausdr\xFCcklich widersprochen. Die Betreiber der Seiten behalten sich ausdr\xFCcklich
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/12.js"() {
    ...
    file3 = "_app/immutable/components/pages/datenschutz/_page.svelte-4935f5d4.js";
    imports3 = ["_app/immutable/components/pages/datenschutz/_page.svelte-4935f5d4.js", "_app/immutable/chunks/index-8132481b.js"];
...
// .svelte-kit/vercel-tmp/datenschutz/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/datenschutz/edge.js
