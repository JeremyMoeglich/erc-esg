...
// .svelte-kit/output/server/entries/endpoints/api/get_own_user_data/_server.ts.js
...
// .svelte-kit/vercel-tmp/api/get_own_user_data/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
  ...
  _: {
    ...
    routes: [
      {
        id: "/api/get_own_user_data",
        pattern: /^\/api\/get_own_user_data\/?$/,
        params: [],
        page: null,
...
// .svelte-kit/vercel-tmp/api/get_own_user_data/edge.js
