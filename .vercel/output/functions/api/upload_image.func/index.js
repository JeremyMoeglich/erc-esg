...
async function validate_get_admin_body(request, schema) {
...
// .svelte-kit/output/server/entries/endpoints/api/upload_image/_server.ts.js
var server_ts_exports = {};
__export(server_ts_exports, {
  POST: () => POST
});
async function upload_image(id, image) {
...
var upload_response_schema, POST;
var init_server_ts = __esm({
  ".svelte-kit/output/server/entries/endpoints/api/upload_image/_server.ts.js"() {
    ...
    init_prisma_client();
    init_index2();
    upload_response_schema = mod.object({
      fileId: mod.string(),
      fileType: mod.string(),
      url: mod.string()
    });
...
// .svelte-kit/vercel-tmp/api/upload_image/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/api/upload_image/edge.js
