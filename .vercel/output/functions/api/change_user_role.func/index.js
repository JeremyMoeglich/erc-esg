...
// .svelte-kit/output/server/entries/endpoints/api/change_user_role/_server.ts.js
...
// .svelte-kit/vercel-tmp/api/change_user_role/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
  ...
  _: {
    ...
    routes: [
      {
        id: "/api/change_user_role",
        pattern: /^\/api\/change_user_role\/?$/,
        params: [],
        page: null,
...
// .svelte-kit/vercel-tmp/api/change_user_role/edge.js
