...
// .svelte-kit/output/server/entries/endpoints/api/update_article/_server.ts.js
...
// .svelte-kit/vercel-tmp/api/update_article/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
  ...
  _: {
    ...
    routes: [
      {
        id: "/api/update_article",
        pattern: /^\/api\/update_article\/?$/,
        params: [],
        page: null,
...
// .svelte-kit/vercel-tmp/api/update_article/edge.js
