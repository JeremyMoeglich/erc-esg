...
async function has_admin_access(request) {
...
// .svelte-kit/output/server/entries/endpoints/api/contacts/_server.ts.js
var server_ts_exports = {};
__export(server_ts_exports, {
  GET: () => GET,
  POST: () => POST
});
var import_cuid, POST, GET;
...
// .svelte-kit/vercel-tmp/api/contacts/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/api/contacts/edge.js
