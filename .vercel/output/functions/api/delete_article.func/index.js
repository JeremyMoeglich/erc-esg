...
// .svelte-kit/output/server/entries/endpoints/api/delete_article/_server.ts.js
...
// .svelte-kit/vercel-tmp/api/delete_article/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
  ...
  _: {
    ...
    routes: [
      {
        id: "/api/delete_article",
        pattern: /^\/api\/delete_article\/?$/,
        params: [],
        page: null,
...
// .svelte-kit/vercel-tmp/api/delete_article/edge.js
