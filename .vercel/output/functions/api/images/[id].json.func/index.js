...
// .svelte-kit/output/server/entries/endpoints/api/images/_id_.json/_server.ts.js
...
// .svelte-kit/vercel-tmp/api/images/[id].json/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
  ...
  _: {
    ...
    routes: [
      {
        id: "/api/images/[id].json",
        pattern: /^\/api\/images\/([^/]+?)\.json\/?$/,
...
// .svelte-kit/vercel-tmp/api/images/[id].json/edge.js
