...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Circle2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${["circle svelte-1w4sjib", pause ? "pause-animation" : ""].join(" ").trim()}" style="${"--size: " + escape2(size2, true) + escape2(unit, true) + "; --colorInner: " + escape2(colorInner, true) + "; --colorCenter: " + escape2(colorCenter, true) + "; --colorOuter: " + escape2(colorOuter, true) + "; --durationInner: " + escape2(durationInner, true) + "; --durationCenter: " + escape2(durationCenter, true) + "; --durationOuter: " + escape2(durationOuter, true) + ";"}"></div>`;
    });
    css = {
...
var init_User = __esm({
  ".svelte-kit/output/server/chunks/User.js"() {
    init_chunks();
    User = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let labelled;
      let attributes;
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M16 4a5 5 0 11-5 5 5 5 0 015-5m0-2a7 7 0 107 7A7 7 0 0016 2zM26 30H24V25a5 5 0 00-5-5H13a5 5 0 00-5 5v5H6V25a7 7 0 017-7h6a7 7 0 017 7z"}"></path></svg>`;
    });
  }
});
...
var DataBase, Home, css2, size, Layout2;
var init_layout_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/admin/_layout.svelte.js"() {
    init_chunks();
    init_auth_state();
    init_User();
    DataBase = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let labelled;
      let attributes;
      let $$restProps = compute_rest_props($$props, ["size", "title"]);
      let { size: size2 = 16 } = $$props;
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M24,3H8A2,2,0,0,0,6,5V27a2,2,0,0,0,2,2H24a2,2,0,0,0,2-2V5A2,2,0,0,0,24,3Zm0,2v6H8V5ZM8,19V13H24v6Zm0,8V21H24v6Z"}"></path><circle cx="${"11"}" cy="${"8"}" r="${"1"}"></circle><circle cx="${"11"}" cy="${"16"}" r="${"1"}"></circle><circle cx="${"11"}" cy="${"24"}" r="${"1"}"></circle></svg>`;
    });
    Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M16.6123,2.2138a1.01,1.01,0,0,0-1.2427,0L1,13.4194l1.2427,1.5717L4,13.6209V26a2.0041,2.0041,0,0,0,2,2H26a2.0037,2.0037,0,0,0,2-2V13.63L29.7573,15,31,13.4282ZM18,26H14V18h4Zm2,0V18a2.0023,2.0023,0,0,0-2-2H14a2.002,2.002,0,0,0-2,2v8H6V12.0615l10-7.79,10,7.8005V26Z"}"></path></svg>`;
    });
    css2 = {
      code: ".outer.svelte-1lqxhjb.svelte-1lqxhjb{display:flex;gap:20px;width:100%;padding:10px}.sidebar_tabs.svelte-1lqxhjb.svelte-1lqxhjb{display:flex;flex-direction:column;align-items:center;gap:10px;padding:10px;background-color:var(--gray100);border-radius:10px;box-shadow:0px 0px 10px rgba(0, 0, 0, 0.1)}.sidebar_tabs.svelte-1lqxhjb>.svelte-1lqxhjb{padding:15px;background-color:var(--gray200);box-shadow:0px 0px 10px rgba(0, 0, 0, 0.2);border-radius:5px;cursor:pointer;transition-duration:200ms}.sidebar_tabs.svelte-1lqxhjb>.svelte-1lqxhjb:hover{color:var(--primary-color);background-color:var(--secondary-color);box-shadow:0px 0px 0px rgba(0, 0, 0, 0.4);transform:scale(1.05)}",
      map: null
    };
    size = 32;
    Layout2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${$admin_mode ? `<div class="${"outer svelte-1lqxhjb"}"><div class="${"sidebar_tabs svelte-1lqxhjb"}"><a href="${"/admin"}" class="${"svelte-1lqxhjb"}">${validate_component(Home, "Home").$$render($$result, { size }, {}, {})}</a>
			<a href="${"/admin/admin_user"}" class="${"svelte-1lqxhjb"}">${validate_component(User, "User").$$render($$result, { size }, {}, {})}</a>
			<a href="${"/admin/contacts"}" class="${"svelte-1lqxhjb"}">${validate_component(DataBase, "DataBase").$$render($$result, { size }, {}, {})}</a></div>
		<div class="${"content"}"><h1>Admin Panel</h1>
			${slots.default ? slots.default({}) : ``}</div></div>` : `${$logged_in ? `<h2>Sie haben keinen Zugriff auf diese Seite</h2>` : `<h2>Sie sind nicht angemeldet</h2>`}`}`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/admin/_layout.svelte-fbca2956.js";
    imports3 = ["_app/immutable/components/pages/admin/_layout.svelte-fbca2956.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/auth_state-7a238df3.js", "_app/immutable/chunks/index-674a61bc.js", "_app/immutable/chunks/User-5b2ccb62.js"];
    stylesheets3 = ["_app/immutable/assets/_layout-433c3df7.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/output/server/entries/pages/admin/admin_user/_page.svelte.js
var page_svelte_exports = {};
__export(page_svelte_exports, {
  default: () => Page
});
async function change_role(email, role) {
  const response = await fetch("/api/change_user_role", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
...
async function get_admins() {
  ...
  const { admins } = mod.object({
    admins: mod.array(
      user_data_schema.extend({
        role: mod.literal("admin")
      })
    )
  }).parse(await response.json());
  return admins;
}
var Locked, css4, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/admin/admin_user/_page.svelte.js"() {
    ...
    init_lib();
    init_User();
    Locked = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let labelled;
      let attributes;
      let $$restProps = compute_rest_props($$props, ["size", "title"]);
      let { size: size2 = 16 } = $$props;
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M24,14H22V8A6,6,0,0,0,10,8v6H8a2,2,0,0,0-2,2V28a2,2,0,0,0,2,2H24a2,2,0,0,0,2-2V16A2,2,0,0,0,24,14ZM12,8a4,4,0,0,1,8,0v6H12ZM24,28H8V16H24Z"}"></path></svg>`;
    });
    css4 = {
      code: ".add_admin.svelte-1nmk5gi.svelte-1nmk5gi{display:flex;gap:20px;align-items:center}.user.svelte-1nmk5gi.svelte-1nmk5gi{display:flex;align-items:center;gap:20px;background-color:var(--gray000);padding:10px;border-radius:5px;margin:10px;border:2px solid var(--secondary-color);box-shadow:0px 0px 4px rgba(0, 0, 0, 0.3)}.user.svelte-1nmk5gi>p.svelte-1nmk5gi{padding:10px}button.svelte-1nmk5gi.svelte-1nmk5gi{background-color:var(--gray300);border:2px solid var(--secondary-color);border-radius:5px;padding:10px;color:var(--secondary-color);box-shadow:0px 0px 4px rgba(0, 0, 0, 0.3);transition-duration:300ms}button.svelte-1nmk5gi.svelte-1nmk5gi:hover{background-color:white;color:var(--primary-color);box-shadow:0px 0px 4px rgba(0, 0, 0, 0.3);transform:scale(1.02)}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $user_datas_store, $$unsubscribe_user_datas_store;
      $$unsubscribe_user_datas_store = subscribe(user_datas_store, (value) => $user_datas_store = value);
      let admins = void 0;
      (async () => {
        admins = await get_admins();
      })();
      function is_locked(user_data) {
        return user_data.id === "cl3lwm64k000473wpz1alp5di" || user_data.id === ($user_datas_store == null ? void 0 : $user_datas_store.id);
      }
      let email;
      $$result.css.add(css4);
      $$unsubscribe_user_datas_store();
      return `<div><h2>List of Admins</h2>
	${admins ? `<div>${each(admins, (admin) => {
        return `<div class="${"user svelte-1nmk5gi"}"><p class="${"svelte-1nmk5gi"}">${validate_component(User, "User").$$render($$result, {}, {}, {})}
						${escape2(admin.name)}
						${admin.tag ? `- (${escape2(admin.tag)})` : ``}</p>
					${is_locked(admin) ? `<div class="${"locked"}">Locked ${validate_component(Locked, "Locked").$$render($$result, {}, {}, {})}</div>` : `<button class="${"svelte-1nmk5gi"}">Admin Entfernen</button>`}
				</div>`;
      })}</div>` : ``}
	<div class="${"add_admin svelte-1nmk5gi"}">${validate_component(Button, "Button").$$render(
        $$result,
        {
          text: "Add Admin",
          onclick: async () => {
		...
		<input type="${"email"}" name="${"email"}"${add_attribute("value", email, 0)}></div>
</div>`;
    });
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    ...
    file4 = "_app/immutable/components/pages/admin/admin_user/_page.svelte-0323ce8a.js";
    imports4 = ["_app/immutable/components/pages/admin/admin_user/_page.svelte-0323ce8a.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/button-e8e119c3.js", "_app/immutable/chunks/user_data-73545cb4.js", "_app/immutable/chunks/index-674a61bc.js", "_app/immutable/chunks/datatypes-f51f27d5.js", "_app/immutable/chunks/index-1d5742ea.js", "_app/immutable/chunks/User-5b2ccb62.js"];
    stylesheets4 = ["_app/immutable/assets/_page-cb443e90.css", "_app/immutable/assets/button-9f2706db.css"];
    fonts4 = [];
  }
});
...
// .svelte-kit/vercel-tmp/admin/admin_user/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/admin/admin_user/edge.js
