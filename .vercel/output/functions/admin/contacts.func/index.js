...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/admin/contacts/_page.svelte.js"() {
    init_chunks();
    css3 = {
      code: ".forms.svelte-1hvqrdl{display:flex;flex-direction:column;gap:20px}.contact_form.svelte-1hvqrdl{display:flex;gap:20px;background-color:var(--gray000);padding:20px}.data.svelte-1hvqrdl{flex:1}.message.svelte-1hvqrdl{flex:2}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css3);
      return `<div class="${"forms svelte-1hvqrdl"}">${each(contact_forms, (contact_form) => {
        return `<div class="${"contact_form svelte-1hvqrdl"}"><div class="${"data svelte-1hvqrdl"}"><h3>Informationen</h3>
				<p>${escape2(new Date(contact_form.createdAt).toLocaleString("de-DE"))}</p>
				<p>Name: ${escape2(contact_form.name)}</p>
				<p>Email: ${escape2(contact_form.email)}</p>
				${contact_form.phone ? `<p>Phone: ${escape2(contact_form.phone)}</p>` : ``}</div>
			<div class="${"message svelte-1hvqrdl"}"><h3>Nachricht:</h3>
				<p>${escape2(contact_form.message)}</p></div>
		</div>`;
      })}
</div>`;
    });
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/8.js"() {
    ...
    file4 = "_app/immutable/components/pages/admin/contacts/_page.svelte-1452982a.js";
    imports4 = ["_app/immutable/components/pages/admin/contacts/_page.svelte-1452982a.js", "_app/immutable/chunks/index-8132481b.js"];
    stylesheets4 = ["_app/immutable/assets/_page-d87647ad.css"];
    fonts4 = [];
  }
});
...
// .svelte-kit/vercel-tmp/admin/contacts/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/admin/contacts/edge.js
