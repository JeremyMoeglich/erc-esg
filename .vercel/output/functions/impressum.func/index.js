...
// .svelte-kit/output/server/entries/pages/impressum/_page.svelte.js
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/impressum/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `<div class="${"outer svelte-1voksky"}"><h1 class="${"svelte-1voksky"}">Impressum</h1>
	<div class="${"svelte-1voksky"}"><p class="${"svelte-1voksky"}">Angaben gem\xE4\xDF \xA7 5 TMG:</p></div>
	<div class="${"svelte-1voksky"}"><p class="${"svelte-1voksky"}">Ecological Revolutionary Company eSG am Landschulheim Schloss Heessen</p>
		<p class="${"svelte-1voksky"}">Schlossstr. 1</p>
		<p class="${"svelte-1voksky"}">59073 Hamm</p></div>
	<div class="${"svelte-1voksky"}"><h3>Vertreten durch:</h3>
		<p class="${"svelte-1voksky"}">Die Sch\xFCler des Schloss Heessen in Hamm</p></div>
	<div class="${"svelte-1voksky"}"><h3>Aufsichtsvorsitzende:</h3>
		<p class="${"svelte-1voksky"}">Mats Funke und Paul Dufhues</p></div>
	<div class="${"svelte-1voksky"}"><h3>Kontakt:</h3>
		<p class="${"svelte-1voksky"}">ercesg.schlossheessen@gmail.com</p></div>
	<div class="${"svelte-1voksky"}"><h3>Registereintrag</h3>
		<p class="${"svelte-1voksky"}">Eintragung im Genossenschaftsregister.</p>
		<p class="${"svelte-1voksky"}">Registergericht: RWGV-M\xFCnster e.V.</p>
		<p class="${"svelte-1voksky"}">Registernummer: 2012 - HAM -004</p></div>
	<div class="${"svelte-1voksky"}"><p class="${"svelte-1voksky"}">Harald Hoffmann</p>
		<p class="${"svelte-1voksky"}">Schlossstr. 1</p>
		<p class="${"svelte-1voksky"}">59073 Hamm</p></div>
	<div class="${"svelte-1voksky"}"><h2>Haftungsausschluss</h2>
		<div class="${"svelte-1voksky"}"><h3>Haftung f\xFCr Inhalte</h3>
			<p class="${"svelte-1voksky"}">Als Diensteanbieter sind wir gem\xE4\xDF \xA7 7 Abs.1 TMG f\xFCr eigene Inhalte auf diesen Seiten nach
				den allgemeinen Gesetzen verantwortlich. Nach \xA7\xA7 8 bis 10 TMG sind wir als Diensteanbieter
				jedoch nicht verpflichtet, \xFCbermittelte oder gespeicherte fremde Informationen zu \xFCberwachen
				oder nach Umst\xE4nden zu forschen, die auf eine rechtswidrige T\xE4tigkeit hinweisen.
				Verpflichtungen zur Entfernung oder Sperrung der Nutzung von Informationen nach den
				allgemeinen Gesetzen bleiben hiervon unber\xFChrt. Eine diesbez\xFCgliche Haftung ist jedoch erst
				ab dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung m\xF6glich. Bei Bekanntwerden
				von entsprechenden Rechtsverletzungen werden wir diese Inhalte umgehend entfernen.
			</p></div>
		<div class="${"svelte-1voksky"}"><h3>Haftung f\xFCr Links</h3>
			<p class="${"svelte-1voksky"}">Unser Angebot enth\xE4lt Links zu externen Websites Dritter, auf deren Inhalte wir keinen
				Einfluss haben. Deshalb k\xF6nnen wir f\xFCr diese fremden Inhalte auch keine Gew\xE4hr \xFCbernehmen.
				F\xFCr die Inhalte der verlinkten Seiten ist stets der jeweilige Anbieter oder Betreiber der
				Seiten verantwortlich. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf
				m\xF6gliche Rechtsverst\xF6\xDFe \xFCberpr\xFCft. Rechtswidrige Inhalte waren zum Zeitpunkt der Verlinkung
		...
		<div class="${"svelte-1voksky"}"><h3>Urheberrecht</h3>
			<p class="${"svelte-1voksky"}">Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem
				deutschen Urheberrecht. Die Vervielf\xE4ltigung, Bearbeitung, Verbreitung und jede Art der
				Verwertung au\xDFerhalb der Grenzen des Urheberrechtes bed\xFCrfen der schriftlichen Zustimmung
				des jeweiligen Autors bzw. Erstellers. Downloads und Kopien dieser Seite sind nur f\xFCr den
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/13.js"() {
    ...
    file3 = "_app/immutable/components/pages/impressum/_page.svelte-aef836da.js";
    imports3 = ["_app/immutable/components/pages/impressum/_page.svelte-aef836da.js", "_app/immutable/chunks/index-8132481b.js"];
    stylesheets3 = ["_app/immutable/assets/_page-506e070f.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/vercel-tmp/impressum/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/impressum/edge.js
