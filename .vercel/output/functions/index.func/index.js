...
// .svelte-kit/output/server/chunks/local_changes.js
var update_index;
var init_local_changes = __esm({
  ".svelte-kit/output/server/chunks/local_changes.js"() {
    init_index3();
    update_index = writable(0);
  }
});
...
var require_cuid = __commonJS({
  "node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/index.js"(exports, module) {
    ...
    var blockSize = 4;
    var base2 = 36;
    var discreteValues = Math.pow(base2, blockSize);
    function randomBlock() {
      return pad((getRandomValue() * discreteValues << 0).toString(base2), blockSize);
    }
    ...
    function cuid() {
      var letter = "c", timestamp = new Date().getTime().toString(base2), counter = pad(safeCounter().toString(base2), blockSize), print = fingerprint(), random = randomBlock() + randomBlock();
...
// .svelte-kit/output/server/chunks/article_browser.js
var import_cuid, Search, css$12, Search_bar, css2, Article_browser;
var init_article_browser = __esm({
  ".svelte-kit/output/server/chunks/article_browser.js"() {
    init_chunks();
    init_local_changes();
    init_datatypes();
    init_auth_state();
    import_cuid = __toESM(require_cuid(), 1);
    init_delay();
    Search = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M29,27.5859l-7.5521-7.5521a11.0177,11.0177,0,1,0-1.4141,1.4141L27.5859,29ZM4,13a9,9,0,1,1,9,9A9.01,9.01,0,0,1,4,13Z"}"></path></svg>`;
    });
    css$12 = {
      code: "div.svelte-15wmmtb{display:flex;border:1px solid var(--gray400);height:40.5px;width:247.5px;background-color:var(--gray000)}button.svelte-15wmmtb{display:flex;justify-content:center;align-items:center;height:100%;width:40.5px;border:3px solid transparent;padding:3px;background:none;cursor:pointer}button.svelte-15wmmtb:hover{border:3px solid var(--secondary-color)}input.svelte-15wmmtb{border:none;background:none;width:100%;height:100%;padding:0px 10px;font-size:14px;color:#333;outline:none;border-right:var(--gray400) solid 1px}",
      map: null
    };
    Search_bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $$unsubscribe_in_delay;
      let $$unsubscribe_out_delay;
      $$unsubscribe_in_delay = subscribe(in_delay, (value2) => value2);
      $$unsubscribe_out_delay = subscribe(out_delay, (value2) => value2);
      let { value = "" } = $$props;
      let { on_search } = $$props;
      if ($$props.value === void 0 && $$bindings.value && value !== void 0)
        $$bindings.value(value);
      if ($$props.on_search === void 0 && $$bindings.on_search && on_search !== void 0)
        $$bindings.on_search(on_search);
      $$result.css.add(css$12);
      $$unsubscribe_in_delay();
      $$unsubscribe_out_delay();
      return `<div class="${"svelte-15wmmtb"}"><input placeholder="${"Suche"}" type="${"search"}" class="${"svelte-15wmmtb"}"${add_attribute("value", value, 0)}>
	<button title="${"Suchen"}" class="${"svelte-15wmmtb"}">${validate_component(Search, "Search").$$render($$result, { fill: "var(--primary-color)", size: 32 }, {}, {})}</button>
</div>`;
    });
    css2 = {
      code: ".outer.svelte-1mtzz50{display:flex;flex-direction:column;align-items:center;height:100%;width:100%;gap:20px;padding:30px calc(10vw - 40px)}",
      map: null
    };
    Article_browser = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $$unsubscribe_update_index;
      $$unsubscribe_update_index = subscribe(update_index, (value) => value);
      let { page: page2 = 0 } = $$props;
      let search_value = "";
      let filter = { search: "" };
      async function update_items(filter2, page22) {
        if (!filter2) {
          return;
        }
      }
      ...
      do {
        ...
        $$rendered = `<div class="${"outer svelte-1mtzz50"}"><div>${validate_component(Search_bar, "SearchBar").$$render(
          $$result,
          {
            on_search: async () => {
...
var image_cache_store, Edit, css$13, Db_image_content, css3, Db_image;
...
var css$14, Field, css4, Fields, Action_fields;
...
var css5, Showcase, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_chunks();
    init_article_browser();
    init_action_fields();
    init_db_image();
    init_delay();
    css5 = {
      code: '.main.svelte-y01lpw{display:flex;flex-direction:row;align-items:center;flex-wrap:wrap;justify-content:space-evenly;width:100%;height:100%;padding:30px 0px;gap:60px}.left.svelte-y01lpw{display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:27px;width:500px;max-width:100%}.right.svelte-y01lpw{width:1000px}h1.svelte-y01lpw{font-family:"Roboto", sans-serif;font-size:50px;font-weight:500}',
      map: null
    };
    Showcase = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $$unsubscribe_in_delay;
      let $$unsubscribe_out_delay;
      $$unsubscribe_in_delay = subscribe(in_delay, (value) => value);
      $$unsubscribe_out_delay = subscribe(out_delay, (value) => value);
      $$result.css.add(css5);
      $$unsubscribe_in_delay();
      $$unsubscribe_out_delay();
      return `<div class="${"main svelte-y01lpw"}"><div class="${"left svelte-y01lpw"}"><h1 class="${"svelte-y01lpw"}">Ecological Revolutionary Company</h1>
		<p>Wir sind ein junges, kreatives und lebensbewusstes Team. Wir sind umweltbewusst und wollen mit
			unserem Engagement f\xFCr die Zukunft unserer Welt einen positiven Einfluss auf unsere Umwelt
			haben.
		</p></div>
	<div class="${"right svelte-y01lpw"}">${validate_component(Db_image, "DbImage").$$render($$result, { id: "showcase_image", width: "100%" }, {}, {})}</div>
</div>`;
    });
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${validate_component(Showcase, "Showcase").$$render($$result, {}, {}, {})}
${validate_component(Action_fields, "IndexFields").$$render($$result, {}, {}, {})}
${validate_component(Article_browser, "ArticleBrowser").$$render($$result, {}, {}, {})}`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-908b64ba.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-908b64ba.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/article_browser-79b96710.js", "_app/immutable/chunks/articles-885999f7.js", "_app/immutable/chunks/index-674a61bc.js", "_app/immutable/chunks/datatypes-f51f27d5.js", "_app/immutable/chunks/index-1d5742ea.js", "_app/immutable/chunks/db_image-fcafce18.js", "_app/immutable/chunks/auth_state-7a238df3.js", "_app/immutable/chunks/ArrowUp.svelte_svelte_type_style_lang-c73ae56d.js", "_app/immutable/chunks/button-e8e119c3.js", "_app/immutable/chunks/delay-2aed76c9.js", "_app/immutable/chunks/action_fields-d892675e.js"];
    stylesheets3 = ["_app/immutable/assets/_page-6316fccb.css", "_app/immutable/assets/article_browser-1dbb36e4.css", "_app/immutable/assets/db_image-b271afda.css", "_app/immutable/assets/ArrowUp-01af3612.css", "_app/immutable/assets/button-9f2706db.css", "_app/immutable/assets/action_fields-27de7521.css"];
    fonts3 = [];
  }
});
