...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/account/_page.svelte.js"() {
    ...
    init_user_data();
    css2 = {
      code: ".outer.svelte-1p2c5k6.svelte-1p2c5k6{padding:50px 70px;background-color:var(--gray300);width:fit-content}h1.svelte-1p2c5k6.svelte-1p2c5k6{margin-top:0px}.items.svelte-1p2c5k6.svelte-1p2c5k6{display:flex;flex-direction:column;align-items:center;gap:20px}.items.svelte-1p2c5k6>div.svelte-1p2c5k6{padding:10px}.password.svelte-1p2c5k6.svelte-1p2c5k6{background-color:var(--gray200)}.field.svelte-1p2c5k6.svelte-1p2c5k6{width:100%}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"outer svelte-1p2c5k6"}"><h1 class="${"svelte-1p2c5k6"}">Account</h1>
	${user_data ? `<div class="${"items svelte-1p2c5k6"}"><div class="${"field svelte-1p2c5k6"}"><div>Name:</div>
				<div>${escape2(user_data.name)}</div></div>
			<div class="${"field svelte-1p2c5k6"}">Email: ${escape2(user_data.email)}</div>
			<div class="${"password svelte-1p2c5k6"}"><div class="${"field svelte-1p2c5k6"}">Neues Passwort:
					<input type="${"password"}" name="${"new_password"}"></div>
				<div class="${"field svelte-1p2c5k6"}">Passwort wiederholen:
					<input type="${"password"}" name="${"new_password_repeat"}"></div></div></div>` : ``}
</div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    file3 = "_app/immutable/components/pages/account/_page.svelte-3049b793.js";
    imports3 = ["_app/immutable/components/pages/account/_page.svelte-3049b793.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/user_data-73545cb4.js", "_app/immutable/chunks/index-674a61bc.js"];
    stylesheets3 = ["_app/immutable/assets/_page-3be58955.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/vercel-tmp/account/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/account/edge.js
