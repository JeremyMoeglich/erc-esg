  ...
  "node_modules/.pnpm/zod@3.19.1/node_modules/zod/lib/index.mjs"() {
    ...
    ZodMap = class extends ZodType {
      _parse(input) {
        ...
        const keyType = this._def.keyType;
        const valueType = this._def.valueType;
        const pairs = [...ctx.data.entries()].map(([key2, value], index4) => {
          return {
            key: keyType._parse(new ParseInputLazyPath(ctx, key2, ctx.path, [index4, "key"])),
...
// .svelte-kit/output/server/chunks/db_image.js
var image_cache_store, Edit, css$12, Db_image_content, css2, Db_image;
var init_db_image = __esm({
  ".svelte-kit/output/server/chunks/db_image.js"() {
    init_chunks();
    init_auth_state();
    init_index3();
    image_cache_store = writable({});
    Edit = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M2 26H30V28H2zM25.4 9c.8-.8.8-2 0-2.8 0 0 0 0 0 0l-3.6-3.6c-.8-.8-2-.8-2.8 0 0 0 0 0 0 0l-15 15V24h6.4L25.4 9zM20.4 4L24 7.6l-3 3L17.4 7 20.4 4zM6 22v-3.6l10-10 3.6 3.6-10 10H6z"}"></path></svg>`;
    });
    css$12 = {
      code: "img.svelte-roua6y{width:100%;height:100%;object-fit:cover}",
      map: null
    };
    Db_image_content = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $image_cache_store, $$unsubscribe_image_cache_store;
      $$unsubscribe_image_cache_store = subscribe(image_cache_store, (value) => $image_cache_store = value);
      let { id } = $$props;
      let { attr = "" } = $$props;
      async function update_image_url(id2) {
      }
      ...
      $$unsubscribe_image_cache_store();
      return `${($image_cache_store == null ? void 0 : $image_cache_store[id]) ? `<img${add_attribute("src", `${$image_cache_store[id]}?tr=${attr}`, 0)}${add_attribute("alt", id, 0)} class="${"svelte-roua6y"}">` : ``}`;
    });
    css2 = {
      code: ".outer.svelte-ncddq1.svelte-ncddq1{display:inline-block;position:relative;height:fit-content;width:fit-content}.content.svelte-ncddq1.svelte-ncddq1{height:fit-content}.overlay.svelte-ncddq1.svelte-ncddq1{position:absolute;padding:10px;top:0;left:0;right:0;bottom:0;z-index:1;background-color:rgba(0, 0, 0, 0.349);filter:opacity(0);transition-duration:200ms}.overlay.svelte-ncddq1.svelte-ncddq1:hover,.loading.svelte-ncddq1.svelte-ncddq1{filter:opacity(1)}.edit_file_input.svelte-ncddq1.svelte-ncddq1{position:relative;background-color:var(--gray200);color:var(--secondary-color);border-radius:40%;width:50px;height:50px}.edit_file_input.svelte-ncddq1.svelte-ncddq1:hover{background-color:var(--gray000);color:var(--primary-color)}.edit_file_symbol.svelte-ncddq1.svelte-ncddq1{width:100%;height:100%;display:flex;justify-content:center;align-items:center}.edit_file_input.svelte-ncddq1>input.svelte-ncddq1{position:absolute;top:0;left:0;width:100%;height:100%;opacity:0}",
      map: null
    };
    Db_image = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let str_width;
      let $admin_mode, $$unsubscribe_admin_mode;
      $$unsubscribe_admin_mode = subscribe(admin_mode, (value) => $admin_mode = value);
      let { id } = $$props;
      let { click = void 0 } = $$props;
      ...
      $$unsubscribe_admin_mode();
      return `<div class="${"outer svelte-ncddq1"}"${add_styles({ "width": str_width })}><div class="${"content svelte-ncddq1"}">${typeof click === "function" ? `<button>${validate_component(Db_image_content, "DbImageContent").$$render($$result, { id, attr }, {}, {})}</button>` : `${typeof click === "string" ? `<a${add_attribute("href", click, 0)} data-sveltekit-prefetch>${validate_component(Db_image_content, "DbImageContent").$$render($$result, { id, attr }, {}, {})}</a>` : `<div>${validate_component(Db_image_content, "DbImageContent").$$render($$result, { id, attr }, {}, {})}</div>`}`}</div>
	${$admin_mode ? `<div class="${["overlay svelte-ncddq1", ""].join(" ").trim()}">${`<div class="${"edit_file_input svelte-ncddq1"}"><div class="${"edit_file_symbol svelte-ncddq1"}">${validate_component(Edit, "Edit").$$render($$result, { size: 24 }, {}, {})}</div>
					<input type="${"file"}" class="${"svelte-ncddq1"}"></div>`}</div>` : ``}
</div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/action_fields.js
var css$13, Field, css3, Fields, Action_fields;
var init_action_fields = __esm({
  ".svelte-kit/output/server/chunks/action_fields.js"() {
    init_chunks();
    init_db_image();
    init_delay();
    css$13 = {
      code: ".outer.svelte-1h832pv{display:flex;flex-direction:column;align-items:center;padding:20px 30px;text-align:center;background-color:var(--gray000);border-radius:10px;box-shadow:0px 2px 10px -5px var(--secondary-color)}h3.svelte-1h832pv{margin-top:0px}",
      map: null
    };
    Field = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.title === void 0 && $$bindings.title && title !== void 0)
        $$bindings.title(title);
      if ($$props.image_id === void 0 && $$bindings.image_id && image_id !== void 0)
        $$bindings.image_id(image_id);
      if ($$props.text === void 0 && $$bindings.text && text !== void 0)
        $$bindings.text(text);
      $$result.css.add(css$13);
      return `<div class="${"outer svelte-1h832pv"}"><h3 class="${"svelte-1h832pv"}">${escape2(title)}</h3>
	${validate_component(Db_image, "DbImage").$$render(
        $$result,
        {
          id: image_id,
    ...
    css3 = {
      code: ".main.svelte-1fr1uze{display:grid;grid-template-columns:repeat(auto-fit, minmax(300px, 1fr));gap:10px;padding:30px 60px;width:100%}.outer.svelte-1fr1uze{display:flex;flex-direction:column;align-items:center}",
      map: null
    };
    Fields = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { fields } = $$props;
      let { title } = $$props;
      ...
      if ($$props.title === void 0 && $$bindings.title && title !== void 0)
        $$bindings.title(title);
      $$result.css.add(css3);
      return `<div class="${"outer svelte-1fr1uze"}"><h2>${escape2(title)}</h2>
	<div class="${"main svelte-1fr1uze"}">${each(fields, (field) => {
    ...
    Action_fields = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${validate_component(Fields, "Fields").$$render(
        $$result,
        {
          title: "Unsere Leistungen",
          fields: [
            {
              title: "Geb\xE4ude Thermographie",
              image_id: "gebaeude_thermographie",
              text: `Bei einer Geb\xE4udethermographie schauen wir mittels einer W\xE4rmebildkammera nach lecks in der W\xE4rmed\xE4mmung von H\xE4usern.`
            },
            {
              title: "Leuchtmittel Analyse",
              image_id: "leuchtmittel_analyse",
              text: `Bei einer Leuchtmittel Analyse schauen wir uns die verwendeten Leuchtmittel an und errchnen ggf. den eingesparten wert, bei einsatz von neuen Leuchtmitteln.`
            },
            {
              title: "Analyse der Elektronischen Ger\xE4te",
              image_id: "elektronische_geraete_analyse",
              text: `Bei der Analyse der Elektronischen Ger\xE4te untersuchen wir zum einen die Effiziens der Ger\xE4te, aber auch deren Platzierung.`
            },
            {
              title: "Analyse des Nutzungsverhaltens",
              image_id: "nutzungsverhalten_analyse",
              text: `Bei der Analyse des Nutzungsverhaltens schauen wir auf das individulle l\xFCftungs, heitz und sonstige verhalten, im bezug auf die Energie effizientz.`
            }
          ]
        },
        {},
...
var Section_fields, css4, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/about/_page.svelte.js"() {
    init_chunks();
    init_action_fields();
    Section_fields = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${validate_component(Fields, "Fields").$$render(
        $$result,
        {
          ...
          fields: [
            {
              title: "Beratung",
              image_id: "beratung",
              text: `Die Mitarbeiter der Beratung k\xFCmmern sich um das operative Gesch\xE4ft und werden daf\xFCr gezielt weitergebildet.`
            },
            {
              title: "Kundenzufriedenheit",
              image_id: "kundenzufriedenheit",
              text: `Die Mitarbeiter der Kundenzufriedenheit k\xFCmmern sich um die Optimierung der Prozesse um die Zufriedenhet der Kunden zu Steigern.`
            },
            {
              title: "Marketing",
              image_id: "marketing",
              text: `Die Marketingabteilung betreibt unsere Social Media Accounts und k\xFCmmert sich um die Kundenaquirirung. `
            },
            {
              title: "Buchhaltung",
              image_id: "buchhaltung",
              text: `Die Buchhaltung k\xFCmmert sich um die Finanzen der Sch\xFClerfirma und bereitet die Generalversammlung vor.`
            },
            {
              title: "IT",
              image_id: "it",
              text: "Die Mitareiter der IT k\xFCmmer sich um die digitale Infrastruktur und unsere Website."
            },
            {
              title: "Wettbewerbe",
              image_id: "wettbewerbe",
              text: "Als Sch\xFClerfrima sind Wettbewerbe ein Stetiger Begleiter. Deshalb k\xFCmmert sich die Wettbewerbsabteilung um die Bewerbung und Abwicklung von Wettbewerben"
            }
          ]
        },
        {},
    ...
    css4 = {
      code: ".outer.svelte-1voksky.svelte-1voksky{display:flex;flex-direction:column;padding:min(20px, 4%);background-color:rgba(255, 255, 255, 0.493);border-radius:10px;border:1px rgba(0, 0, 0, 0.274) solid;backdrop-filter:blur(10px);max-width:1300px;width:calc(100% - min(20px, 4%) * 2);margin:50px auto}.outer.svelte-1voksky div.svelte-1voksky{padding:min(10px, 2%)}.outer.svelte-1voksky p.svelte-1voksky{padding:2px}.outer.svelte-1voksky h1.svelte-1voksky{color:var(--secondary-color)}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css4);
      return `<div class="${"outer svelte-1voksky"}"><h1 class="${"svelte-1voksky"}">\xDCber uns</h1>
	<div class="${"svelte-1voksky"}"><div class="${"svelte-1voksky"}"><h2>Unsere Mission</h2>
			<p class="${"svelte-1voksky"}">Die ERC eSG ber\xE4t Sie gerne in puncto Energieeinsparung. Wir sind unabh\xE4ngig, kompetent und
				motiviert, zusammen mit Ihnen einen Beitrag zur Rettung unseres Planeten zu leisten. Anders
				als unsere Mitbewerber sind wir nicht auf externe Firmen angewiesen und beraten Sie v\xF6llig
				objektiv. Au\xDFerdem sind wir nicht so kostenintensiv wie unsere Konkurrenten. Langfristig
				werden die Energiekosten immer teurer. Mit unseren praktischen Tipps k\xF6nnen Sie die Kosten
				senken. Unser Angebot richtet sich prim\xE4r an Privathaushalte sowie kleine Betriebe. Unser
		...
		<div class="${"svelte-1voksky"}"><h2>Unsere Geschichte</h2>
			<p class="${"svelte-1voksky"}">Schon lange gab es am Schloss Heessen die \xDCberlegung, eine Sch\xFClerfirma zu gr\xFCnden. Den
				Sch\xFClerinnen und Sch\xFClern der Oberstufe sollte die Gelegenheit gegeben werden, erste
				Erfahrungen im F\xFChren eines eigenen Unternehmens zu sammeln. Im Schuljahr 2011/12 konnte
				dieser Wunsch endlich in die Tat umgesetzt werden. Unterst\xFCtzt von den Projektpartnern DEG,
				dem Rheinisch-Westf\xE4lischen Genossenschaftsverband und der Fachhochschule SRH Hamm, wagte
				eine Gruppe von interessierten Sch\xFClerinnen und Sch\xFCler der Jahrgangsstufe 12 - engagiert
				beraten von Herrn Hoffmann - den Sprung in die Selbstst\xE4ndigkeit. W\xE4hrend ihrer
				Gr\xFCndungsphase wurden und auch bei ihrer weiteren Professionalisierung werden die
				Sch\xFClerinnen und Sch\xFCler kompetent von der DEG insbesondere in Fragen des Marketings, der
				Buchf\xFChrung und der Energieeffizienz fortgebildet. Am 6. Dezember 2011 wurde nach allen
				m\xFChsamen Vorarbeiten im Haus der DEG die Ecological Revolutionary Company offiziell
				gegr\xFCndet. Seitdem haben die Mitglieder der ERC erfolgreich Beratungsauftr\xE4ge durchgef\xFChrt,
				ihr Unternehmen stetig weiterentwickelt und zahlreiche Veranstaltungen rund um das Thema
				Energiesparen besucht
			</p></div>
		<div class="${"svelte-1voksky"}"><h2>Wir f\xFCr Sie</h2>
			<p class="${"svelte-1voksky"}">Die ERC eSG ber\xE4t Sie gerne in puncto Energieeinsparung. Wir sind unabh\xE4ngig, kompetent und
				motiviert, zusammen mit Ihnen einen Beitrag zur Rettung unseres Planeten zu leisten. Anders
				als unsere Mitbewerber sind wir nicht auf externe Firmen angewiesen und beraten Sie v\xF6llig
				objektiv. Au\xDFerdem sind wir nicht so kostenintensiv wie unsere Konkurrenten. Langfristig
		...
		<div class="${"svelte-1voksky"}"><h2>Qualit\xE4t</h2>
			<p class="${"svelte-1voksky"}">Um die Qualit\xE4t in unserer Beratung auch als Sch\xFClerfirma zu gew\xE4hrleisten arbeiten wir mit
				kompetentten Partner aus der Region zuammen. <br>
				An erster Stelle w\xE4re dabei unsere Partnergenossenschaft die Dach Fassde Holz eG anzuf\xFChren.
				Dar\xFCber hinaus arbeiten wir auch mit SRH Hochschule in Hamm zusammen. <br>
				Beide unterst\xFCtzen uns aber nicht nur in der Beratung sondern auch in der Abwicklung der Prozesse,
				damit wir trotz Schulischem Betrieb schnellstm\xF6glich ihre Auftr\xE4ge Bearbeiten.
			</p></div></div></div>
${validate_component(Action_fields, "ActionFields").$$render($$result, {}, {}, {})}
${validate_component(Section_fields, "SectionFields").$$render($$result, {}, {}, {})}`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    file3 = "_app/immutable/components/pages/about/_page.svelte-e5bd13b9.js";
    imports3 = ["_app/immutable/components/pages/about/_page.svelte-e5bd13b9.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/action_fields-d892675e.js", "_app/immutable/chunks/db_image-fcafce18.js", "_app/immutable/chunks/auth_state-7a238df3.js", "_app/immutable/chunks/index-674a61bc.js", "_app/immutable/chunks/index-1d5742ea.js", "_app/immutable/chunks/ArrowUp.svelte_svelte_type_style_lang-c73ae56d.js", "_app/immutable/chunks/delay-2aed76c9.js"];
    stylesheets3 = ["_app/immutable/assets/_page-506e070f.css", "_app/immutable/assets/action_fields-27de7521.css", "_app/immutable/assets/db_image-b271afda.css", "_app/immutable/assets/ArrowUp-01af3612.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/vercel-tmp/about/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/about/edge.js
