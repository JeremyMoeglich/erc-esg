...
var init_button = __esm({
  ".svelte-kit/output/server/chunks/button.js"() {
    init_chunks();
    css3 = {
      code: ".main.svelte-18nu05u.svelte-18nu05u{width:128px;height:48px}.main.svelte-18nu05u .btn.svelte-18nu05u{display:flex;justify-content:center;align-items:center;font-size:large;width:100%;height:100%;transition-duration:500ms;background-color:var(--primary-color);box-shadow:0px 2px 10px -5px var(--secondary-color);border-radius:10px}.main.svelte-18nu05u .btn.svelte-18nu05u:hover{background-color:#cdffff;box-shadow:0px 2px 17px -1px var(--primary-color);cursor:pointer}.important.svelte-18nu05u .btn.svelte-18nu05u{font-weight:bold;border:2px solid var(--primary-color);box-shadow:0px 2px 10px -3px var(--primary-color)}.important.svelte-18nu05u .btn.svelte-18nu05u:hover{box-shadow:0px 2px 10px 0px var(--primary-color)}",
      map: null
    };
    Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      let { text } = $$props;
      let { onclick } = $$props;
      if ($$props.important === void 0 && $$bindings.important && important !== void 0)
        $$bindings.important(important);
      if ($$props.text === void 0 && $$bindings.text && text !== void 0)
        $$bindings.text(text);
      if ($$props.onclick === void 0 && $$bindings.onclick && onclick !== void 0)
        $$bindings.onclick(onclick);
      $$result.css.add(css3);
      return `<div class="${["main svelte-18nu05u", important ? "important" : ""].join(" ").trim()}">${typeof onclick === "function" ? `<button class="${"btn svelte-18nu05u"}">${escape2(text)}</button>` : `<a${add_attribute("href", onclick, 0)} class="${"btn svelte-18nu05u"}" data-sveltekit-prefetch>${escape2(text)}</a>`}
</div>`;
    });
  }
});
...
// .svelte-kit/output/server/entries/pages/articles/_article_id_/_page.svelte.js
var page_svelte_exports = {};
__export(page_svelte_exports, {
  default: () => Page
});
async function update_article(article) {
  const response = await fetch("/api/update_article", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
  ...
  update_index.set(get_store_value(update_index) + 1);
}
var articles_cache_store, css$13, Inplaceedit, css4, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/articles/_article_id_/_page.svelte.js"() {
    ...
    init_local_changes();
    init_navigation();
    articles_cache_store = writable({});
    css$13 = {
      code: "input.svelte-1lhsa3f{border:none;background:none;font-size:inherit;color:inherit;font-weight:inherit;text-align:inherit;box-shadow:none}",
      map: null
    };
    Inplaceedit = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { value } = $$props;
      ...
      return `${`<div>${escape2(value)}</div>`}`;
    });
    css4 = {
      code: ".outer.svelte-1xrakgo{display:flex;width:90%;margin:50px auto;gap:40px}@media(max-width: 1200px){.outer.svelte-1xrakgo{flex-direction:column}.image.svelte-1xrakgo{align-self:center}}.article.svelte-1xrakgo{width:100%}.editor.svelte-1xrakgo *{z-index:3}.save_button.svelte-1xrakgo{display:flex;justify-content:center;margin-top:2rem}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $articles_cache_store, $$unsubscribe_articles_cache_store;
      let $page, $$unsubscribe_page;
      let $admin_mode, $$unsubscribe_admin_mode;
      $$unsubscribe_articles_cache_store = subscribe(articles_cache_store, (value) => $articles_cache_store = value);
      $$unsubscribe_page = subscribe(page, (value) => $page = value);
      $$unsubscribe_admin_mode = subscribe(admin_mode, (value) => $admin_mode = value);
      let article_id = get_store_value(page).params.article_id;
      let state = "loading";
      async function load(article_id2) {
      }
      let article_obj = void 0;
      $$result.css.add(css4);
      article_id = $page.params.article_id;
      {
        {
          state = "loading";
          const preview_in_cache = get_store_value(articles_cache_store)[article_id] ? true : false;
          if (!preview_in_cache) {
            is_loading.set(true);
          }
          load();
      ...
      article_obj = $articles_cache_store == null ? void 0 : $articles_cache_store[article_id];
      $$unsubscribe_articles_cache_store();
      $$unsubscribe_page();
      $$unsubscribe_admin_mode();
      return `<div class="${"outer svelte-1xrakgo"}">${article_obj ? `<div class="${"image svelte-1xrakgo"}">${validate_component(Db_image, "DbImage").$$render(
        $$result,
        {
          id: (article_obj == null ? void 0 : article_obj.image_link_id) ?? article_id,
          width: "300px"
        },
        {},
        {}
      )}</div>
		<div class="${"article svelte-1xrakgo"}"><h1>${state !== "loading" ? `${$admin_mode ? `${validate_component(Inplaceedit, "Inplaceedit").$$render($$result, { value: article_obj.title }, {}, {})}` : `${escape2(article_obj.title)}`}` : ``}</h1>
			${"content" in article_obj ? `<div>${$admin_mode ? `<div class="${"editor svelte-1xrakgo"}"></div>
						<div class="${"save_button svelte-1xrakgo"}">${validate_component(Button, "Button").$$render(
        $$result,
        {
          text: "Speichern",
          onclick: async () => {
            if (article_obj === void 0) {
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/9.js"() {
    ...
    file3 = "_app/immutable/components/pages/articles/_article_id_/_page.svelte-262dbd1d.js";
    imports3 = ["_app/immutable/components/pages/articles/_article_id_/_page.svelte-262dbd1d.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/db_image-fcafce18.js", "_app/immutable/chunks/auth_state-7a238df3.js", "_app/immutable/chunks/index-674a61bc.js", "_app/immutable/chunks/index-1d5742ea.js", "_app/immutable/chunks/ArrowUp.svelte_svelte_type_style_lang-c73ae56d.js", "_app/immutable/chunks/button-e8e119c3.js", "_app/immutable/chunks/articles-885999f7.js", "_app/immutable/chunks/datatypes-f51f27d5.js", "_app/immutable/chunks/loading_store-b28525d0.js", "_app/immutable/chunks/stores-88328872.js", "_app/immutable/chunks/singletons-96e64e34.js", "_app/immutable/chunks/navigation-93d63568.js"];
    stylesheets3 = ["_app/immutable/assets/_page-a5eac35b.css", "_app/immutable/assets/db_image-b271afda.css", "_app/immutable/assets/ArrowUp-01af3612.css", "_app/immutable/assets/button-9f2706db.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/vercel-tmp/articles/[article_id]/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
    ...
    routes: [
      {
        ...
        pattern: /^\/articles\/([^/]+?)\/?$/,
        params: [{ "name": "article_id", "optional": false, "rest": false, "chained": false }],
...
// .svelte-kit/vercel-tmp/articles/[article_id]/edge.js
