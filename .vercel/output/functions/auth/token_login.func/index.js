...
// .svelte-kit/output/server/entries/endpoints/auth/token_login/_server.ts.js
...
var init_server_ts = __esm({
  ".svelte-kit/output/server/entries/endpoints/auth/token_login/_server.ts.js"() {
    ...
    POST = async ({ request }) => {
      ...
      if (loginToken.time.getTime() < Date.now() - 1e3 * 60 * 60 * 24 * 7) {
...
// .svelte-kit/vercel-tmp/auth/token_login/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/auth/token_login/edge.js
