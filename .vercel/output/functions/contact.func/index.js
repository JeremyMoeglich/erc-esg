...
function arrayLikeKeys(value, inherited) {
  ...
  for (var key2 in value) {
    if ((inherited || hasOwnProperty5.call(value, key2)) && !(skipIndexes && (key2 == "length" || isBuff && (key2 == "offset" || key2 == "parent") || isType && (key2 == "buffer" || key2 == "byteLength" || key2 == "byteOffset") || isIndex_default(key2, length)))) {
      result.push(key2);
    }
  }
  return result;
...
function arrayPush(array2, values) {
  var index4 = -1, length = values.length, offset = array2.length;
  while (++index4 < length) {
    array2[offset + index4] = values[index4];
  }
  return array2;
}
...
var objectProto12, propertyIsEnumerable2, nativeGetSymbols, getSymbols, getSymbols_default;
...
var objectProto13, hasOwnProperty10, initCloneArray_default;
...
async function submit_form(contact_form) {
  if (contact_form.id === "") {
...
var Email, css4, Contact_form, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/contact/_page.svelte.js"() {
    ...
    init_functional_utilities();
    init_lodash();
    Email = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let labelled;
      let attributes;
      ...
      return `<svg${spread(
        ...
        {}
      )}>${title ? `<title>${escape2(title)}</title>` : ``}<path d="${"M28,6H4A2,2,0,0,0,2,8V24a2,2,0,0,0,2,2H28a2,2,0,0,0,2-2V8A2,2,0,0,0,28,6ZM25.8,8,16,14.78,6.2,8ZM4,24V8.91l11.43,7.91a1,1,0,0,0,1.14,0L28,8.91V24Z"}"></path></svg>`;
    });
    css4 = {
      code: ".form.svelte-kqur7b{display:flex;width:800px;max-width:100%;padding:30px;margin:50px;background-color:var(--gray100);min-height:700px;width:min(100%, 600px);box-shadow:0px 5px 10px rgba(0, 0, 0, 0.205);border-radius:10px;margin-left:auto;margin-right:auto;flex-direction:column;align-items:center;gap:40px}.top.svelte-kqur7b{display:flex;flex-direction:column;align-items:center}.items.svelte-kqur7b{width:100%}h2.svelte-kqur7b{margin-bottom:0px}",
      map: null
    };
    Contact_form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const default_form = {
        "Name*": { value: "", autocomplete: "name" },
        "Email*": { value: "", autocomplete: "email" },
        "Nachricht*": { value: "", autocomplete: "text" },
        "Telefon Nummer": { value: "", autocomplete: "tel" }
      };
      let contact_form = cloneDeep_default(default_form);
      $$result.css.add(css4);
      let $$settled;
      let $$rendered;
      do {
        $$settled = true;
        $$rendered = `<div class="${"form svelte-kqur7b"}"><div class="${"top svelte-kqur7b"}">${validate_component(Email, "Email").$$render($$result, { size: 32 }, {}, {})}
		<h2 class="${"svelte-kqur7b"}">Kontaktformular</h2></div>
	<div class="${"items svelte-kqur7b"}">${each(typed_keys(contact_form), (text) => {
          return `${validate_component(Input_field, "InputField").$$render(
            $$result,
            {
              ...
              value: contact_form[text].value
            },
            {
              value: ($$value) => {
                contact_form[text].value = $$value;
                $$settled = false;
              }
            },
            {}
	...
	${validate_component(Button, "Button").$$render(
          $$result,
          {
            ...
            onclick: async () => {
              ...
              contact_form = cloneDeep_default(default_form);
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/11.js"() {
    ...
    file3 = "_app/immutable/components/pages/contact/_page.svelte-50734a74.js";
    imports3 = ["_app/immutable/components/pages/contact/_page.svelte-50734a74.js", "_app/immutable/chunks/index-8132481b.js", "_app/immutable/chunks/button-e8e119c3.js", "_app/immutable/chunks/input_field-cec05477.js", "_app/immutable/chunks/loading_store-b28525d0.js", "_app/immutable/chunks/index-674a61bc.js", "_app/immutable/chunks/index-afe3ebdb.js"];
    stylesheets3 = ["_app/immutable/assets/_page-b40ae1e4.css", "_app/immutable/assets/button-9f2706db.css", "_app/immutable/assets/input_field-c61dede8.css"];
    fonts3 = [];
  }
});
...
// .svelte-kit/vercel-tmp/contact/manifest.js
var manifest = {
  appDir: "_app",
  appPath: "_app",
...
// .svelte-kit/vercel-tmp/contact/edge.js
